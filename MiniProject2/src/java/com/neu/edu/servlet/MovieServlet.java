...
import com.neu.edu.database.MoviesDatabase;
...
public class MovieServlet extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        if(actionValue.equals("addMovieOption")){
            RequestDispatcher reqAddMoviePage = request.getRequestDispatcher("WEB-INF/jsp/add-new-movie.jsp");
            reqAddMoviePage.forward(request, response);
            
        }
        
        if(actionValue.equals("browseMovieOption")){
            RequestDispatcher reqBrowseMoviePage = request.getRequestDispatcher("WEB-INF/jsp/browse-movie.jsp");
        ...
        if(actionValue.equals("addMoviePage")){
            ...
            try {
                ...
                RequestDispatcher reqAddMovieSuccessPage = request.getRequestDispatcher("WEB-INF/jsp/add-movie-success.jsp");
                reqAddMovieSuccessPage.forward(request, response);
            } catch (SQLException ex) {
                System.out.println("Redirecting to AddMovieExistsPage......");
                RequestDispatcher reqAddMovieSuccessPage = request.getRequestDispatcher("WEB-INF/jsp/add-movie-exists.jsp");
                reqAddMovieSuccessPage.forward(request, response);
        ...
        if(actionValue.equals("browseMoviePage")){
            ...
            try {
                ...
                RequestDispatcher reqBrowseMovie = request.getRequestDispatcher("WEB-INF/jsp/browse-movie-success.jsp");
